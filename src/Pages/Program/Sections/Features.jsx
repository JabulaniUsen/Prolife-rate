...
function Features() {
  ...
  return (
    <div className='poppins px-10 lg:px-28 my-28'>
      <div className=''>
        <div className='header-text'>
          <h1 className='text-[#186BAD] text-4xl font-semibold'>
        ...
        <div className="flex gap-y-10 flex-row justify-between items-center flex-wrap my-10">
            ...
            <div
                key={item.id}
                className='body border-2 rounded-2xl p-3 flex flex-col gap-5 items-center text-center bg-[#fafafa] w-[350px] h-[400px]'
            >
