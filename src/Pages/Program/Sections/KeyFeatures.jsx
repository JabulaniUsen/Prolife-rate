...
function KeyFeatures() {
  return (
    <div className='poppins mx-10 lg:mx-28 px-6 lg:px-6 py-5 my-16 relative'>
        ...
        <div className="border-2 rounded-2xl  bg-white relative lg:p-14 p-10">
            <div className="">
                <h1 className='text-2xl text-[#186BAD] font-semibold'>Key Features of Our Program</h1>
                <p className='font-semibold'>Our program encompasses a variety of key features to enhance your learning experience:</p>
            </div>
            <div className="pt-10 flex flex-col gap-5">
                <div className="">
                    <h2 className='text-[#186BAD] text-lg font-semibold'>1. Tutoring Services</h2>
                    <ul className='list-disc ml-10 font-semibold'>
